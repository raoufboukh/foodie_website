        ...
        <div className="lg:basis-[45%] basis-[80%] pt-5 mx-auto lg:mx-0">
          ...
          <div>
            ...
            <div className="flex gap-2 items-center">
              <div className="flex items-center gap-2 sm:text-sm text-xs rounded-md border border-gray-400 px-2 py-1 cursor-pointer hover:shadow-lg transition-shadow duration-300 mx-auto">
